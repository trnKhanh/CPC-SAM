...
from utils import test_single_volume_mean, test_single_volume_mean_prompt
...
def inference_prompt(args, multimask_output, db_config, model, test_save_path=None):
    ...
    for case in tqdm(image_list):
        ...
        metric_i = test_single_volume_mean_prompt(image, label, model, classes=args.num_classes, multimask_output=multimask_output,
    ...
    logging.info("Testing prompt Finished!")
    return 1
...
if __name__ == '__main__':
    ...
    inference_prompt(args, multimask_output, dataset_config[dataset_name], net, test_save_path=test_save_path)
